...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (curStage)
		{
			...
			case 'castle':
				{
					var bg:FlxSprite = new FlxSprite(-500, -300).loadGraphic(Paths.image('scenary/PrincessCastleBG/PrincessCastleBG', 'shared'));
					bg.antialiasing = true;
					bg.scrollFactor.set(0.9, 0.9);
					bg.setGraphicSize(Std.int(bg.width * 0.8111111));
					bg.active = false;
					add(bg);
			...
			case 'koopa':
				{
					var XD = Paths.getSparrowAtlas('scenary/BowsersShipBG/BowsersShipBG', 'shared');
					//var bg2323232:FlxSprite = new FlxSprite(-900, -680).loadGraphic(Paths.image('scenary/BowsersShipBG/BowsersShipBG', 'shared'));
					bg23232323 = new FlxSprite(-600, -300); //jijijija
					bg23232323.frames = XD;
					bg23232323.antialiasing = true;
					bg23232323.animation.addByPrefix('idle', 'BowsersShipBG', 10);
					bg23232323.animation.play('idle');
					bg23232323.setGraphicSize(Std.int(bg23232323.width * 0.8111111));
					add(bg23232323);
				}
			case 'lab':
				{
					var bg:FlxSprite = new FlxSprite(-500, -225).loadGraphic(Paths.image('scenary/AbandonedLabBG/AbandonedLabBG', 'shared'));
					bg.antialiasing = true;
					bg.scrollFactor.set(0.9, 0.9);
					bg.setGraphicSize(Std.int(bg.width * 0.8111111));
					bg.active = false;
					...
					var algo:FlxSprite = new FlxSprite(-35, 700);
					algo.frames = Paths.getSparrowAtlas('scenary/AbandonedLabBG/Fawful_Bop', 'shared');
					algo.animation.addByPrefix('dance', 'Fawful Bop ', 24);
					algo.animation.play('dance');
					algo.scrollFactor.set(0.9, 0.9);
					algo.antialiasing = true;
					add(algo);
	...
	override public function update(elapsed:Float)
	{
		...
		if (dad.curCharacter == "fawful")
		{
			dad.y += Math.sin(volarxdxdxd) * 1.3;
